        ...
        <div class="container py-3">
            <header>
                ...
                <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                    <h1 class="display-4 fw-normal text-body-emphasis">Book a hotel</h1>
                    <p class="fs-5 text-body-secondary">This is the hotel booking price. Available to choose from as follows:</p>
                </div>
            </header>
            ...
            <main>
                <div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div class="card-header py-3">
                                <h4 class="my-0 fw-normal">child</h4>
                            </div>
                            <div class="card-body">
                                <h1 class="card-title pricing-card-title">$1668<small
                                        class="text-body-secondary fw-light">/mo</small></h1>
                                <ul class="list-unstyled mt-3 mb-4">
                                    <li>ห้องธรรมดา</li>
                                    <li>มีของเล่นอำนวยความสะดวก</li>
                                    <li>ราคาเริ่มต้นเพียง</li>
                                    <li>คืนละ 2,000 บาท</li>
                                </ul>
                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm">
                            <div class="card-header py-3">
                                <h4 class="my-0 fw-normal">Promotion for clild</h4>
                            </div>
                            <div class="card-body">
                                <h1 class="card-title pricing-card-title">$333<small
                                        class="text-body-secondary fw-light">/mo</small></h1>
                                <ul class="list-unstyled mt-3 mb-4">
                                    <li>โปรโมชั่นสำหรับเด็กเล็ก</li>
                                    <li>รับเพียงเเรก 20 ท่านเท่านั้น</li>
                                    <li>ราคาเริ่มต้นเพียง</li>
                                    <li>คืนละ 395 บาท</li>
                                </ul>
                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm border-primary">
                            <div class="card-header py-3 text-bg-primary border-primary">
                                <h4 class="my-0 fw-normal">Adult</h4>
                            </div>
                            <div class="card-body">
                                <h1 class="card-title pricing-card-title">$4170<small
                                        class="text-body-secondary fw-light">/mo</small></h1>
                                <ul class="list-unstyled mt-3 mb-4">
                                    <li>ห้องสำหรับผู้ใหญ่</li>
                                    <li>มีบริการอย่างดีเยี่ยม</li>
                                    <li>ราคาเริ่มต้นเพียง</li>
                                    <li>คืนละ 5,000 บาท</li>
                                </ul>
                    ...
                    <table class="table text-center">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 22%;">Promotion for clild</th>
                                <th style="width: 22%;">Adult</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
